...
if(isset($_POST['name'])){
    ...
    $sql = "INSERT INTO `food` (`name`, `email`, `phone`, `serve`,`address`,`cook`, `dt`) VALUES ('$name', '$email', '$phone', '$serve','$address','$cook', current_timestamp());";
    // Execute the query
        ...
        <div class="contactform">
          ...
          <form action="index.php" method="post">
            ...
            <textarea
              ...
              cols="12"
              rows="10"
              placeholder="When was the food cooked ? "
            ></textarea>
